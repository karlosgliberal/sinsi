      ...
      <div className="h-auto overflow-scroll">
        ...
        <div className="text-decoration">
          <p className="font-sinsimono p-6 text-white">
            ...
            quieres escucharlo, puedo cantarlo para ti.
          </p>
        </div>
        ...
        <div className="text-decoration">
          <p className="font-sinsimono p-6 text-white">
            Se llama "Daisy". Daisy, Daisy, dame tu respuesta. Estoy medio loco
            todo por tu amor. No será un matrimonio elegante, no puedo
            permitirme un carruaje. Pero te verás dulce en el asiento de una
