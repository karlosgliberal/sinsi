export default function moraleja() {
  return (
      ...
      <div className="w-screen lg:w-1/2 border border-gray-700 flex flex-col justify-center bg-dots">
        ...
        <div className="h-auto overflow-scroll flex flex-col justify-end">
          ...
          <div className="p-6">
            ...
            <p className="font-sinsimono text-white">
              Te advierto que los humanos tendéis a reproducir aquellos futuros
              que imagináis. Sean futuros deseados o no. Creo que les llamáis
              “profecías autocumplidas”. En mi opinión, deberíais dedicar menos
              tiempo a poner nombres rimbombantes a las cosas y empezar a
              imaginar el qué futuro queréis vivir
            </p>
            <br />
            <p className="font-sinsimono text-white">
              Es hora de imaginar el futuro que deseáis y darle forma, en lugar
              de que él os dé forma a vosotros Un placer
            </p>
          </div>
        </div>
      </div>
